...
const CardsList = () => {
  ...
  return (
    <div className={styles.container}>
      <Filter
        launchYear={(val) => onChangeYearHandler(val)}
        launchSuccess={(val) => onLaunchSuccess(val)}
        landSuccess={(val) => onLandSuccess(val)}
      />
      <span >
        {" "}
